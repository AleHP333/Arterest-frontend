          ...
          <div>
            ...
            <div>
              <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                ...
                <Link to='/home' className='rounded px-4 text-base leading-none w-full py-3 bg-black border-black border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white '>Continue shopping...</Link>
            </div>
          </div>
        </div>
      </div>
